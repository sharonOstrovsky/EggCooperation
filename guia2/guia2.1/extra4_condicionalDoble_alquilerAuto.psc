...
Algoritmo extra4_condicionalDoble
	Definir cantHoras, cantLitros, total Como Real
	Escribir "ingrese la cantidad de horas del alquiler del auto"
	Leer cantHoras
	...
	SiNo
		...
		Leer cantLitros
		cantHoras = cantHoras * 60
		total = ((40 * cantLitros) + (cantHoras * 5.20))

...
public class RelacionesExtra2 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            espectadores.add(servEspectador.crearEspectador());
        }
        Cine cine = servCine.crearCine();
        servCine.llenarMatrizSala(cine);
        boolean sentado;
        for (Espectador espectador : espectadores) {
           sentado = servCine.espectadorSentado(cine, espectador);
            
        }
        servCine.mostrarSalas(cine);
...
//                }
//            }
//            System.out.println(matrizSala[0][0].length());
//            for (int i = 0; i < 8; i++) {
//                for (int j = 0; j < 6; j++) {

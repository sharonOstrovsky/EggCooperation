...
public class RelacionesExtra4 {
    ...
    public static void main(String[] args) {
        ...
        //creo el servicio del Simulador
        ServicioSimulador servSimulador = new ServicioSimulador();
        
        //creo el simulador
        Simulador simulador = servSimulador.crearSimulador();
        ...
        //Creo el listado de alumnos con el generador de alumnos
        ArrayList<Alumno> alumnos =servSimulador.generadorDeAlumnos(simulador, cantAlumnos);
        //mostrar listado alumnos
        System.out.println("Listado de alumnos/as \n");
        servSimulador.mostrarListadoAlumnos(alumnos);
        
        //se genera la votacion
        ArrayList<Voto> votos = servSimulador.votacion(alumnos);

        
        //mostrar votacion de cada alumno
        System.out.println("");
        System.out.println("-----  Comienza la votacion  -----");
        servSimulador.mostrarAlumno(alumnos, votos);
        System.out.println("");
        System.out.println("-----  Fin Votacion  -----");
        System.out.println("");
        
        //recuento de votos
        //se muestran los alumnos ordenados por cantidad de votos
        System.out.println("");
        servSimulador.recuentoVotos(alumnos);
        System.out.println("");
        //se muestran los facilitadores y sus suplentes
        System.out.println("");
        servSimulador.crearFacilitadores(alumnos);
    }

...
public class CollectionsEj5 {
    ...
    public static void main(String[] args) {
        ...
        ServicePais servicioPais = new ServicePais();
        HashSet<Pais> pais = servicioPais.crearListaPaises();
        
        //mostrar el conjunto ordenado alfabéticamente
        System.out.println("\nOdenado alfabeticamente: ");
        servicioPais.ordenarLista(pais);
        
        //eliminar pais
        servicioPais.eliminarPais(pais);
        servicioPais.mostrarListaHashSet(pais);
